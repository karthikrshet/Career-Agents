# NPM Post-Launch Audit: Career-Agents

This audit validates the release state, integrity, and packaging metrics for `career-agents` version `1.1.0`.
...
-   **Unpacked File Count**: 268 files
-   **Unpacked Size**: 3.5 MB
-   **Packed Tarball Size**: **716.2 kB**
-   **Status**: Passed footprint bar (< 1 MB).
