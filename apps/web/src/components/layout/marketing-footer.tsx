        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-x-8 gap-y-12 text-xs text-slate-400 mb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/interview-questions" className="hover:text-indigo-400 transition-colors">Interview Questions</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/dpa" className="hover:text-indigo-400 transition-colors">Data Processing</Link></li>
            </ul>
          </div>
