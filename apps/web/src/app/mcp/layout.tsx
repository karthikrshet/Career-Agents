...
export const metadata: Metadata = {
  ...
  description:
    "Configure Career Agents as an MCP (Model Context Protocol) server. Generate client config files for Cursor, Claude Desktop, VS Code, Windsurf, Cline, RooCode, OpenHands, Bolt, and Aider.",
  keywords: [
  ...
  openGraph: {
    title: "Career Agents MCP Server — Model Context Protocol Config",
