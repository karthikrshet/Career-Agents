...
export const metadata: Metadata = {
  ...
  description:
    "Career Agents is fully open source (MIT). Meet the contributors, explore live GitHub repository stats, clone the project, and join the open source career intelligence ecosystem.",
  keywords: [
  ...
  openGraph: {
    title: "Career Agents Credits — Open Source Contributors",
